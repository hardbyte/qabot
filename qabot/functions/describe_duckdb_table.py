...
def describe_table_or_view(database, table):
    table_columns_and_types_query = f"select column_name, data_type from system.information_schema.columns where table_name='{table}';"
    table_first_rows_query = f"select * from '{table}' limit 5;"
